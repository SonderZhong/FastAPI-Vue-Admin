...
class RoleInfo(DataBaseModel):
    ...
    data_scope: int = Field(default=4, description="数据权限范围")
...
class AddRoleParams(BaseModel):
    ...
    status: int = Field(default=1, description="角色状态")
    department_id: Optional[str] = Field(default=None, description="所属部门ID")
    data_scope: int = Field(default=4, ge=1, le=5, description="数据权限范围")
...
class UpdateRoleParams(BaseModel):
    ...
    department_id: Optional[str] = Field(default=None, description="所属部门ID")
    data_scope: Optional[int] = Field(default=None, ge=1, le=5, description="数据权限范围")
