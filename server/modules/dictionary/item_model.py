...
# @Time : 2026/07/02 23:12
# @UpdateTime : 2026/07/02 23:12
# @Author : SonderZhong
# @File : item_model.py
# @Software : VSCode
# @Comment : 本程序用于
...
class SystemDictionaryItem(DbBaseModel):
    """
    数据字典项表
    """
    ...
    label = fields.CharField(
        max_length=100, null=False, description="字典项标签", source_field="label"
    )
    """
    字典项标签
    """
    value = fields.CharField(
        max_length=100, null=False, description="字典项值", source_field="value"
    )
    """
    字典项值
    """
    ...
    tag_color = fields.CharField(
        max_length=50, null=True, description="标签颜色", source_field="tag_color"
    )
    """
    标签颜色
    """
