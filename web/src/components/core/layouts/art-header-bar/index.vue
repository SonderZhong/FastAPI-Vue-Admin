    ...
    <div class="menu">
      ...
      <div class="right">
        ...
        <div class="user">
          ...
          >
            <template #reference>
              <ElAvatar :size="35" :src="getAvatarUrl(userInfo.avatar)">
                {{ userInfo?.username }}
              </ElAvatar>
            </template>
            <template #default>
              <div class="user-menu-box">
                <div class="user-head">
                  <ElAvatar :size="45" :src="getAvatarUrl(userInfo.avatar)">
                    {{ userInfo?.username }}
                  </ElAvatar>
                  <div class="user-wrap">
                ...
                <ul class="user-menu">
                  ...
                  <li @click="goPage('/personal-login-record')">
                    <i class="menu-icon iconfont-sys">&#xe6ce;</i>
                    <span class="menu-txt">{{ $t('personalLoginRecord.title') }}</span>
                  </li>
                  <li @click="goPage('/personal-operation-record')">
                    <i class="menu-icon iconfont-sys">&#xe6df;</i>
                    <span class="menu-txt">{{ $t('personalOperationRecord.title') }}</span>
                  </li>
                  <li @click="goPage('/my-notification')">
                    <i class="menu-icon iconfont-sys">&#xe6c2;</i>
                    <span class="menu-txt">{{ $t('menus.myNotification.title') }}</span>
                  </li>
                  <li @click="lockScreen()">
                    <i class="menu-icon iconfont-sys">&#xe817;</i>
...
<script setup lang="ts">
  ...
  const loginOut = (): void => {
    ElMessageBox.confirm(t('common.logOutTips'), t('common.tips'), {
      ...
      // 检查响应是否成功
      if (response.success) {
        ElMessage.success(response.msg || '登出成功')
        closeUserMenu()
        userStore.logOut()
      } else {
