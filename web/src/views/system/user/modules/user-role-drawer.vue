    ...
    <div v-if="userData" class="h-full flex flex-col">
      ...
      <div class="user-info-card">
        ...
        <div class="user-info">
          ...
          <div class="user-meta"
            >@{{ userData.username }} · {{ userData.department_name || '暂无部门' }}</div
          >
        </div>
      </div>
            ...
            <ElCheckboxGroup v-model="selectedRoleIds">
              ...
              >
                ...
                <div class="role-content">
                  ...
                  <div class="role-desc">{{ role.description || $t('common.noDescription') }}</div>
                </div>
              </div>
            </ElCheckboxGroup>
          </div>
      ...
      <div class="selection-info">
        <span>{{ $t('user.selectedRolesCount', { count: selectedRoleIds.length }) }}</span>
        <span v-if="hasChanges" class="has-changes">{{ $t('common.hasChanges') }}</span>
      </div>
    </div>

    <template #footer>
      <div class="drawer-footer">
        <ElButton round @click="handleClose">{{ $t('buttons.cancel') }}</ElButton>
        <ElButton
          type="primary"
          round
          :loading="submitting"
