<template>
  <div class="art-full-height">
          ...
          <template #header>
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center gap-2">
                ...
                <ElButton :icon="Refresh" size="small" circle @click="refreshDictionaryList" />
              </div>
            </div>
          </template>
              ...
              <div class="flex items-center justify-between">
                <div class="flex-1 min-w-0">
                  <div class="flex items-center gap-2 mb-1">
                    ...
                    <ElTag :type="dict.status === 1 ? 'success' : 'info'" size="small">
                      {{ dict.status === 1 ? '启用' : '禁用' }}
                    </ElTag>
                  </div>
          ...
          <template #header>
            <div class="flex items-center justify-between">
              ...
              <div v-if="selectedDictionary" class="flex items-center gap-2">
                ...
                <ElButton :icon="Refresh" size="small" circle @click="refreshItemList" />
              </div>
            </div>
          </template>
    ...
    <ElDialog
      ...
      :title="
        dialogType === 'add' ? $t('dictionary.addDictionary') : $t('dictionary.editDictionary')
      "
      width="600px"
    ...
    <ElDialog
      ...
      :title="
        itemDialogType === 'add'
          ? $t('dictionary.addDictionaryItem')
          : $t('dictionary.editDictionaryItem')
      "
      width="600px"
      @close="handleItemDialogClose"
    >
      <ElForm ref="itemFormRef" :model="itemFormData" :rules="itemFormRules" label-width="100px">
        <ElFormItem :label="$t('dictionary.itemLabel')" prop="label">
          <ElInput
            v-model="itemFormData.label"
            :placeholder="$t('dictionary.itemLabelPlaceholder')"
          />
        </ElFormItem>
        <ElFormItem :label="$t('dictionary.itemValue')" prop="value">
          <ElInput
            v-model="itemFormData.value"
            :placeholder="$t('dictionary.itemValuePlaceholder')"
          />
        </ElFormItem>
        <ElFormItem :label="$t('common.status')" prop="status">
